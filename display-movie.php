...
// fetch data about selected movie from db
$title = $res['title'];
...
<body>
    <header>
        ...
        <div class="content">
            ...
            <p style="font-size: small; margin-bottom: 13px;"><?php echo $plot; ?></p>
            ...
            <div class='additon_detail'>
                ...
                <div class="details" style="margin-top: -13px;margin-bottom: -10px;">
                    ...
                    <h3 id="rate"><span>IMDB </span><i class="bi bi-star-fill"></i> <?php echo $movie_rating ?></p>
                    </h3>
                </div>
                <div class="btns">
